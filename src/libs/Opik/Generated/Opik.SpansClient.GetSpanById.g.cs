...
namespace Opik
{
    public partial class SpansClient
    {
        ...
        private static readonly global::Opik.AutoSDKServer[] s_GetSpanByIdServers = new global::Opik.AutoSDKServer[]
        ...
        private static readonly global::Opik.EndPointSecurityRequirement s_GetSpanByIdSecurityRequirement0 =
        ...
        private static readonly global::Opik.EndPointSecurityRequirement[] s_GetSpanByIdSecurityRequirements =
            new global::Opik.EndPointSecurityRequirement[]
            {                s_GetSpanByIdSecurityRequirement0,
            };
        ...
        public async global::System.Threading.Tasks.Task<global::Opik.SpanPublic> GetSpanByIdAsync(
            global::System.Guid id,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Opik.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Opik.AutoSDKHttpResponse<global::Opik.SpanPublic>> GetSpanByIdAsResponseAsync(
            global::System.Guid id,
            bool? stripAttachments = default,
            global::Opik.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::Opik.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetSpanByIdSecurityRequirements,
                operationName: "GetSpanByIdAsync");
                ...
                else
                {
                    await global::Opik.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 404)
                            {
                                ...
                                global::Opik.SpanPublic? __value_404 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_404 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_404 = global::Opik.SpanPublic.FromJson(__content_404, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_404 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::Opik.ApiException<global::Opik.SpanPublic>.Create(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Opik.SpanPublic.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Opik.AutoSDKHttpResponse<global::Opik.SpanPublic>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Opik.SpanPublic.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
