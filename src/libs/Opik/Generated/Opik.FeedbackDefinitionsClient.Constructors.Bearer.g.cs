...
namespace Opik
{
    public sealed partial class FeedbackDefinitionsClient
    {
        /// <inheritdoc cref="FeedbackDefinitionsClient(global::System.Net.Http.HttpClient?, global::System.Uri?, global::System.Collections.Generic.List{global::Opik.EndPointAuthorization}?, bool)"/>
        ...
        /// <summary>
        /// Creates an authenticated FeedbackDefinitionsClient by resolving the configured credential environment variables.
        /// </summary>
        ...
        public static FeedbackDefinitionsClient CreateFromEnvironment(
            global::System.Net.Http.HttpClient? httpClient = null,
            global::System.Uri? baseUri = null,
            global::System.Collections.Generic.List<global::Opik.EndPointAuthorization>? authorizations = null,
            ...
            bool disposeHttpClient = true)
        {
            ...
            var client = new FeedbackDefinitionsClient(
                httpClient,
                baseUri,
                authorizations,
                options,
        ...
        /// <summary>
        /// Tries to create an authenticated FeedbackDefinitionsClient by resolving the configured credential environment variables.
        /// </summary>
        ...
        public static bool TryCreateFromEnvironment(
            out FeedbackDefinitionsClient? client,
            global::System.Net.Http.HttpClient? httpClient = null,
            global::System.Uri? baseUri = null,
            global::System.Collections.Generic.List<global::Opik.EndPointAuthorization>? authorizations = null,
            global::Opik.AutoSDKClientOptions? options = null,
            bool disposeHttpClient = true)
        {
            ...
            client = new FeedbackDefinitionsClient(
                httpClient,
                baseUri,
                authorizations,
                options,
