...
namespace Opik
{
    public partial class OllamaClient
    {
        ...
        private static readonly global::Opik.AutoSDKServer[] s_TestConnectionServers = new global::Opik.AutoSDKServer[]
        ...
        private static readonly global::Opik.EndPointSecurityRequirement s_TestConnectionSecurityRequirement0 =
        ...
        private static readonly global::Opik.EndPointSecurityRequirement[] s_TestConnectionSecurityRequirements =
            new global::Opik.EndPointSecurityRequirement[]
            {                s_TestConnectionSecurityRequirement0,
            };
        partial void PrepareTestConnectionArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::Opik.OllamaInstanceBaseUrlRequest request);
        ...
        public async global::System.Threading.Tasks.Task<global::Opik.OllamaConnectionTestResponse> TestConnectionAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Opik.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Opik.AutoSDKHttpResponse<global::Opik.OllamaConnectionTestResponse>> TestConnectionAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::Opik.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_TestConnectionSecurityRequirements,
                operationName: "TestConnectionAsync");
                ...
                else
                {
                    await global::Opik.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 502)
                            {
                                ...
                                global::Opik.OllamaConnectionTestResponse? __value_502 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_502 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_502 = global::Opik.OllamaConnectionTestResponse.FromJson(__content_502, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_502 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::Opik.ApiException<global::Opik.OllamaConnectionTestResponse>.Create(
                                    statusCode: __response.StatusCode,
                            ...
                            if ((int)__response.StatusCode == 503)
                            {
                                ...
                                global::Opik.ErrorMessage? __value_503 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_503 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_503 = global::Opik.ErrorMessage.FromJson(__content_503, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_503 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Opik.OllamaConnectionTestResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Opik.AutoSDKHttpResponse<global::Opik.OllamaConnectionTestResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Opik.OllamaConnectionTestResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
