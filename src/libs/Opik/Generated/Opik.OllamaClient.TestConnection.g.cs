                ...
                else
                {
                    await global::Opik.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 502)
                            {
                                ...
                                throw new global::Opik.ApiException<global::Opik.OllamaConnectionTestResponse>(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    return
                                        global::Opik.OllamaConnectionTestResponse.FromJson(__content, JsonSerializerContext) ??
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    return
                                        await global::Opik.OllamaConnectionTestResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
