...
namespace Opik
{
    public partial class ReportsClient
    {
        ...
        private static readonly global::Opik.AutoSDKServer[] s_UpdateReportPreferenceServers = new global::Opik.AutoSDKServer[]
        ...
        private static readonly global::Opik.EndPointSecurityRequirement s_UpdateReportPreferenceSecurityRequirement0 =
        ...
        private static readonly global::Opik.EndPointSecurityRequirement[] s_UpdateReportPreferenceSecurityRequirements =
            new global::Opik.EndPointSecurityRequirement[]
            {                s_UpdateReportPreferenceSecurityRequirement0,
            };
        partial void PrepareUpdateReportPreferenceArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref global::System.Guid projectId,
            global::Opik.ReportPreference request);
        partial void PrepareUpdateReportPreferenceRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::System.Guid projectId,
            global::Opik.ReportPreference request);
        partial void ProcessUpdateReportPreferenceResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessUpdateReportPreferenceResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Opik.ReportPreference> UpdateReportPreferenceAsync(
            global::System.Guid projectId,
        ...
        {
            var __response = await UpdateReportPreferenceAsResponseAsync(
                projectId: projectId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Opik.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Opik.AutoSDKHttpResponse<global::Opik.ReportPreference>> UpdateReportPreferenceAsResponseAsync(
            global::System.Guid projectId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareUpdateReportPreferenceArguments(
            ...
            var __authorizations = global::Opik.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_UpdateReportPreferenceSecurityRequirements,
                operationName: "UpdateReportPreferenceAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Opik.PathBuilder(
                                ...
                                servers: s_UpdateReportPreferenceServers,
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareUpdateReportPreferenceRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Opik.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Opik.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "UpdateReportPreferenceAsync",
                                pathTemplate: "$\"/v1/private/projects/{projectId}/reports/preferences\"",
                                httpMethod: "PUT",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessUpdateReportPreferenceResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Opik.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessUpdateReportPreferenceResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Opik.ReportPreference.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Opik.AutoSDKHttpResponse<global::Opik.ReportPreference>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Opik.ReportPreference.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Opik.ReportPreference> UpdateReportPreferenceAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Opik.ReportPreference
            {
            ...
            return await UpdateReportPreferenceAsync(
                projectId: projectId,
                request: __request,
                requestOptions: requestOptions,
