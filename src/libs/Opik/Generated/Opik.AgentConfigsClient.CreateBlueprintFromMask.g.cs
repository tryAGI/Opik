...
namespace Opik
{
    public partial class AgentConfigsClient
    {
        ...
        {
            await CreateBlueprintFromMaskAsResponseAsync(
                projectId: projectId,
                maskId: maskId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Opik.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Opik.AutoSDKHttpResponse> CreateBlueprintFromMaskAsResponseAsync(
            global::System.Guid projectId,
            global::System.Guid maskId,
            global::Opik.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
