...
namespace Opik
{
    ...
    public sealed partial class McpOAuthSourceGenerationContext : global::System.Text.Json.Serialization.JsonSerializerContext
    {
        ...
        ///
        /// </summary>
        public static McpOAuthSourceGenerationContext Default { get; } = new(DefaultOptions);

        private McpOAuthSourceGenerationContext(global::System.Text.Json.JsonSerializerOptions options)
            : base(options)
        {
        }
