...
namespace Opik
{
    public partial class TracesClient
    {
        ...
        private static readonly global::Opik.AutoSDKServer[] s_GetTraceThreadServers = new global::Opik.AutoSDKServer[]
        ...
        private static readonly global::Opik.EndPointSecurityRequirement s_GetTraceThreadSecurityRequirement0 =
        ...
        private static readonly global::Opik.EndPointSecurityRequirement[] s_GetTraceThreadSecurityRequirements =
            new global::Opik.EndPointSecurityRequirement[]
            {                s_GetTraceThreadSecurityRequirement0,
            };
        ...
        public async global::System.Threading.Tasks.Task<global::Opik.TraceThread> GetTraceThreadAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Opik.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Opik.AutoSDKHttpResponse<global::Opik.TraceThread>> GetTraceThreadAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::Opik.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetTraceThreadSecurityRequirements,
                operationName: "GetTraceThreadAsync");
                    ...
                    await global::Opik.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Opik.TraceThread.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Opik.AutoSDKHttpResponse<global::Opik.TraceThread>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Opik.TraceThread.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
