...
namespace Opik
{
    public partial class ReportFailuresClient
    {

        private static readonly global::Opik.AutoSDKServer[] s_FindReportFailuresServers = new global::Opik.AutoSDKServer[]
        ...
        private static readonly global::Opik.EndPointSecurityRequirement s_FindReportFailuresSecurityRequirement0 =
        ...
        private static readonly global::Opik.EndPointSecurityRequirement[] s_FindReportFailuresSecurityRequirements =
            new global::Opik.EndPointSecurityRequirement[]
            {                s_FindReportFailuresSecurityRequirement0,
            };
        partial void PrepareFindReportFailuresArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref global::Opik.FindReportFailuresType type,
            ref global::System.Guid projectId,
            ref int? page,
            ref int? size);
        partial void PrepareFindReportFailuresRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            int? page,
            int? size);
        partial void ProcessFindReportFailuresResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessFindReportFailuresResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Opik.ReportFailurePage> FindReportFailuresAsync(
            global::Opik.FindReportFailuresType type,
            global::System.Guid projectId,
            int? page = default,
            int? size = default,
        ...
        {
            var __response = await FindReportFailuresAsResponseAsync(
                type: type,
                projectId: projectId,
                page: page,
                size: size,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Opik.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Opik.AutoSDKHttpResponse<global::Opik.ReportFailurePage>> FindReportFailuresAsResponseAsync(
            global::Opik.FindReportFailuresType type,
            global::System.Guid projectId,
            int? page = default,
            int? size = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareFindReportFailuresArguments(
            ...
            var __authorizations = global::Opik.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_FindReportFailuresSecurityRequirements,
                operationName: "FindReportFailuresAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Opik.PathBuilder(
                                ...
                                servers: s_FindReportFailuresServers,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Opik.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Opik.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "FindReportFailures",
                                methodName: "FindReportFailuresAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessFindReportFailuresResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Opik.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessFindReportFailuresResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Opik.ReportFailurePage.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Opik.AutoSDKHttpResponse<global::Opik.ReportFailurePage>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Opik.ReportFailurePage.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
