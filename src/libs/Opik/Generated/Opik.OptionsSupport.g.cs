...
namespace Opik
{
    ...
    public sealed class AutoSDKClientOptions
    {
        ...
        /// </summary>
        public global::Opik.AutoSDKRetryOptions Retry { get; set; } = new global::Opik.AutoSDKRetryOptions();
        ...
        /// </summary>
        public global::System.Collections.Generic.List<global::Opik.IAutoSDKHook> Hooks { get; } =
            new global::System.Collections.Generic.List<global::Opik.IAutoSDKHook>();
        ...
        public global::Opik.AutoSDKClientOptions AddHook(
            global::Opik.IAutoSDKHook hook)
        {
        ...
        /// </summary>
        public global::Opik.IAutoSDKAuthorizationProvider? AuthorizationProvider { get; set; }
        ...
        public global::Opik.AutoSDKClientOptions UseAuthorizationProvider(
            global::Opik.IAutoSDKAuthorizationProvider provider)
        {
            AuthorizationProvider = provider ?? throw new global::System.ArgumentNullException(nameof(provider));
            if (Hooks.Find(static x => x is global::Opik.AutoSDKAuthorizationProviderHook) == null)
            {
                Hooks.Add(new global::Opik.AutoSDKAuthorizationProviderHook());
            }
    ...
    public readonly struct AutoSDKAuthorizationValue
    {
        ...
        public static global::Opik.AutoSDKAuthorizationValue Bearer(string token) => new(value: token, scheme: "Bearer");

        /// <summary>Convenience factory for an API-key header.</summary>
        public static global::Opik.AutoSDKAuthorizationValue ApiKeyHeader(string name, string value) =>
    ...
    public interface IAutoSDKAuthorizationProvider
    {
        ...
        global::System.Threading.Tasks.Task<global::System.Collections.Generic.IReadOnlyList<global::Opik.AutoSDKAuthorizationValue>?> ResolveAsync(
            global::Opik.AutoSDKHookContext context);
    }
...
#pragma warning restore CS0618
    ...
    /// </summary>
    public sealed class AutoSDKAuthorizationProviderHook : global::Opik.AutoSDKHook
    {
        /// <inheritdoc />
            ...
            global::Opik.AutoSDKHookContext context)
        {
            ...
            if (perRequest != null && perRequest.Count > 0)
            {
                ...
                global::Opik.AutoSDKHttpRequestOptions.StampAuthorizationOverride(context.Request);
                return;
            }
        ...
        private static void ApplyAuthorization(
            global::System.Net.Http.HttpRequestMessage request,
            global::Opik.AutoSDKAuthorizationValue authorization)
        {
    ...
    public sealed class AutoSDKRequestOptions
    {
        ...
        /// </summary>
        public global::Opik.AutoSDKRetryOptions? Retry { get; set; }
        ...
        /// </summary>
        public global::System.Collections.Generic.IReadOnlyList<global::Opik.AutoSDKAuthorizationValue>? Authorizations { get; set; }
    }
    ...
    /// </summary>
    public abstract class AutoSDKHook : global::Opik.IAutoSDKHook
    {
        /// <inheritdoc />
    ...
    public sealed class AutoSDKHookContext
    {
        ...
        /// </summary>
        public global::Opik.AutoSDKClientOptions ClientOptions { get; set; } = null!;

        /// <summary>
        /// The per-request runtime options.
        /// </summary>
        public global::Opik.AutoSDKRequestOptions? RequestOptions { get; set; }
    ...
    {
        internal static global::Opik.AutoSDKHookContext CreateHookContext(
            string operationId,
            string methodName,
            string pathTemplate,
            string httpMethod,
            ...
            global::Opik.AutoSDKClientOptions clientOptions,
            global::Opik.AutoSDKRequestOptions? requestOptions,
            int attempt,
            int maxAttempts,
            bool willRetry,
        ...
        {
            return new global::Opik.AutoSDKHookContext
            {
        ...
        internal static global::System.TimeSpan GetRetryDelay(
            ...
            int attempt)
        {
            var retryOptions = requestOptions?.Retry ?? clientOptions.Retry ?? new global::Opik.AutoSDKRetryOptions();
        ...
        private static global::System.TimeSpan ClampRetryDelay(
            global::System.TimeSpan delay,
            global::Opik.AutoSDKRetryOptions retryOptions)
        {
        ...
        private static async global::System.Threading.Tasks.Task InvokeHooksAsync(
            global::Opik.AutoSDKClientOptions clientOptions,
            global::System.Func<global::Opik.IAutoSDKHook, global::Opik.AutoSDKHookContext, global::System.Threading.Tasks.Task> callback,
            global::Opik.AutoSDKHookContext context)
        {
