...
namespace Opik
{
    public sealed partial class ManualEvaluationClient
    {
        /// <inheritdoc cref="ManualEvaluationClient(global::System.Net.Http.HttpClient?, global::System.Uri?, global::System.Collections.Generic.List{global::Opik.EndPointAuthorization}?, bool)"/>
        ...
        /// <summary>
        /// Creates an authenticated ManualEvaluationClient by resolving the configured credential environment variables.
        /// </summary>
        ...
        public static ManualEvaluationClient CreateFromEnvironment(
            global::System.Net.Http.HttpClient? httpClient = null,
            global::System.Uri? baseUri = null,
            global::System.Collections.Generic.List<global::Opik.EndPointAuthorization>? authorizations = null,
            ...
            bool disposeHttpClient = true)
        {
            ...
            var client = new ManualEvaluationClient(
                httpClient,
                baseUri,
                authorizations,
                options,
        ...
        /// <summary>
        /// Tries to create an authenticated ManualEvaluationClient by resolving the configured credential environment variables.
        /// </summary>
        ...
        public static bool TryCreateFromEnvironment(
            out ManualEvaluationClient? client,
            global::System.Net.Http.HttpClient? httpClient = null,
            global::System.Uri? baseUri = null,
            global::System.Collections.Generic.List<global::Opik.EndPointAuthorization>? authorizations = null,
            global::Opik.AutoSDKClientOptions? options = null,
            bool disposeHttpClient = true)
        {
            ...
            client = new ManualEvaluationClient(
                httpClient,
                baseUri,
                authorizations,
                options,
