...
namespace Opik
{
    ...
    public sealed partial class ManualEvaluationRequest
    {
        ...
        [global::System.Text.Json.Serialization.JsonConverter(typeof(global::Opik.JsonConverters.ManualEvaluationRequestEntityTypeJsonConverter))]
        [global::System.Text.Json.Serialization.JsonRequired]
        public required global::Opik.ManualEvaluationRequestEntityType EntityType { get; set; }
