...
namespace Opik
{
    public partial class AgentConfigsClient
    {
        ...
        private static readonly global::Opik.AutoSDKServer[] s_CreateAgentConfigServers = new global::Opik.AutoSDKServer[]
        ...
        private static readonly global::Opik.EndPointSecurityRequirement s_CreateAgentConfigSecurityRequirement0 =
        ...
        private static readonly global::Opik.EndPointSecurityRequirement[] s_CreateAgentConfigSecurityRequirements =
            new global::Opik.EndPointSecurityRequirement[]
            {                s_CreateAgentConfigSecurityRequirement0,
            };
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Opik.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Opik.AutoSDKHttpResponse> CreateAgentConfigAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::Opik.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CreateAgentConfigSecurityRequirements,
                operationName: "CreateAgentConfigAsync");
                ...
                else
                {
                    await global::Opik.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 400)
                            {
                                ...
                                global::Opik.ErrorMessageWrite? __value_400 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_400 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_400 = global::Opik.ErrorMessageWrite.FromJson(__content_400, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_400 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::Opik.ApiException<global::Opik.ErrorMessageWrite>.Create(
                            ...
                            if ((int)__response.StatusCode == 409)
                            {
                                ...
                                global::Opik.ErrorMessageWrite? __value_409 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_409 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_409 = global::Opik.ErrorMessageWrite.FromJson(__content_409, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_409 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
        ...
        public async global::System.Threading.Tasks.Task CreateAgentConfigAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Opik.AgentConfigCreateWrite
            {
                ProjectId = projectId,
