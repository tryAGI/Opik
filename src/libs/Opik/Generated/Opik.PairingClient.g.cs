...
namespace Opik
{
    ...
    public sealed partial class PairingClient : global::Opik.IPairingClient, global::System.IDisposable
    {
        ...
        internal global::System.Lazy<global::System.Text.Json.Serialization.JsonSerializerContext> JsonSerializerContextProvider { get; set; } = new(() => global::Opik.PairingSourceGenerationContext.Default);
        ...
        /// <summary>
        /// Creates a new instance of the PairingClient with explicit options but no base URL override.
