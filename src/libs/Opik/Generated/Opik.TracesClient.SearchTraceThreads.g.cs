...
namespace Opik
{
    public partial class TracesClient
    {
        ...
        private static readonly global::Opik.AutoSDKServer[] s_SearchTraceThreadsServers = new global::Opik.AutoSDKServer[]
        ...
        private static readonly global::Opik.EndPointSecurityRequirement s_SearchTraceThreadsSecurityRequirement0 =
        ...
        private static readonly global::Opik.EndPointSecurityRequirement[] s_SearchTraceThreadsSecurityRequirements =
            new global::Opik.EndPointSecurityRequirement[]
            {                s_SearchTraceThreadsSecurityRequirement0,
            };
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::Opik.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_SearchTraceThreadsSecurityRequirements,
                operationName: "SearchTraceThreadsAsync");
                ...
                else
                {
                    await global::Opik.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 400)
                            {
                                ...
                                throw new global::Opik.ApiException<byte[]>(
                            ...
                            try
                            {
                                ...
                                return new global::Opik.ResponseStream(__response, __content);
                            }
                            catch (global::System.Exception __ex)
                            {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Opik.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Opik.AutoSDKHttpResponse<byte[]>> SearchTraceThreadsAsResponseAsync(
                    ...
                    await global::Opik.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    return new global::Opik.AutoSDKHttpResponse<byte[]>(
                                        statusCode: __response.StatusCode,
        ...
        public async global::System.Threading.Tasks.Task<byte[]> SearchTraceThreadsAsync(
            ...
            global::System.Collections.Generic.IList<global::Opik.TraceThreadFilter>? filters = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Opik.TraceThreadSearchStreamRequest
            {
