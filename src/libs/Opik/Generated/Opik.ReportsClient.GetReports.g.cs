...
namespace Opik
{
    public partial class ReportsClient
    {
        ...
        private static readonly global::Opik.AutoSDKServer[] s_GetReportsServers = new global::Opik.AutoSDKServer[]
        ...
        private static readonly global::Opik.EndPointSecurityRequirement s_GetReportsSecurityRequirement0 =
        ...
        private static readonly global::Opik.EndPointSecurityRequirement[] s_GetReportsSecurityRequirements =
            new global::Opik.EndPointSecurityRequirement[]
            {                s_GetReportsSecurityRequirement0,
            };
        partial void PrepareGetReportsArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref global::System.Guid projectId,
            ref int? page,
            ref int? size);
        partial void PrepareGetReportsRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::System.Guid projectId,
            int? page,
            int? size);
        partial void ProcessGetReportsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetReportsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Opik.OllieReportPage> GetReportsAsync(
            global::System.Guid projectId,
            int? page = default,
            int? size = default,
        ...
        {
            var __response = await GetReportsAsResponseAsync(
                projectId: projectId,
                page: page,
                size: size,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Opik.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Opik.AutoSDKHttpResponse<global::Opik.OllieReportPage>> GetReportsAsResponseAsync(
            global::System.Guid projectId,
            int? page = default,
            int? size = default,
            global::Opik.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::Opik.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetReportsSecurityRequirements,
                operationName: "GetReportsAsync");
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Opik.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Opik.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "GetReportsAsync",
                                pathTemplate: "$\"/v1/private/projects/{projectId}/reports\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                else
                {
                    await global::Opik.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetReportsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Opik.OllieReportPage.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Opik.AutoSDKHttpResponse<global::Opik.OllieReportPage>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Opik.OllieReportPage.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
