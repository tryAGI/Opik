...
namespace Opik
{
    ...
    public sealed partial class LogItem
    {
        ...
        [global::System.Text.Json.Serialization.JsonConverter(typeof(global::Opik.JsonConverters.LogItemLevelJsonConverter))]
        public global::Opik.LogItemLevel? Level { get; set; }
        ...
        public LogItem(
            ...
            global::Opik.LogItemLevel? level,
            string? message,
