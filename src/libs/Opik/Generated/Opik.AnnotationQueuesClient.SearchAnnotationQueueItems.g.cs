...
namespace Opik
{
    public partial class AnnotationQueuesClient
    {
        ...
        private static readonly global::Opik.AutoSDKServer[] s_SearchAnnotationQueueItemsServers = new global::Opik.AutoSDKServer[]
        ...
        private static readonly global::Opik.EndPointSecurityRequirement s_SearchAnnotationQueueItemsSecurityRequirement0 =
        ...
        private static readonly global::Opik.EndPointSecurityRequirement[] s_SearchAnnotationQueueItemsSecurityRequirements =
            new global::Opik.EndPointSecurityRequirement[]
            {                s_SearchAnnotationQueueItemsSecurityRequirement0,
            };
        partial void PrepareSearchAnnotationQueueItemsArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref global::System.Guid id,
            global::Opik.AnnotationQueueItemIdsPublic request);
        partial void PrepareSearchAnnotationQueueItemsRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::System.Guid id,
            global::Opik.AnnotationQueueItemIdsPublic request);
        partial void ProcessSearchAnnotationQueueItemsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessSearchAnnotationQueueItemsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);

        /// <summary>
        /// Search annotation queue items<br/>
        ...
        public async global::System.Threading.Tasks.Task<global::Opik.AnnotationQueueItemsPublic> SearchAnnotationQueueItemsAsync(
            global::System.Guid id,
        ...
        {
            var __response = await SearchAnnotationQueueItemsAsResponseAsync(
                id: id,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Opik.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Opik.AutoSDKHttpResponse<global::Opik.AnnotationQueueItemsPublic>> SearchAnnotationQueueItemsAsResponseAsync(
            global::System.Guid id,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareSearchAnnotationQueueItemsArguments(
            ...
            var __authorizations = global::Opik.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_SearchAnnotationQueueItemsSecurityRequirements,
                operationName: "SearchAnnotationQueueItemsAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Opik.PathBuilder(
                                ...
                                servers: s_SearchAnnotationQueueItemsServers,
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareSearchAnnotationQueueItemsRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Opik.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Opik.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "SearchAnnotationQueueItems",
                                methodName: "SearchAnnotationQueueItemsAsync",
                                pathTemplate: "$\"/v1/private/annotation-queues/{id}/items/search\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessSearchAnnotationQueueItemsResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Opik.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessSearchAnnotationQueueItemsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Opik.AnnotationQueueItemsPublic.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Opik.AutoSDKHttpResponse<global::Opik.AnnotationQueueItemsPublic>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Opik.AnnotationQueueItemsPublic.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Opik.AnnotationQueueItemsPublic> SearchAnnotationQueueItemsAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Opik.AnnotationQueueItemIdsPublic
            {
                Ids = ids,
            };

            return await SearchAnnotationQueueItemsAsync(
                id: id,
                request: __request,
                requestOptions: requestOptions,
