...
namespace Opik
{
    public partial class RunnersClient
    {
        ...
        private static readonly global::Opik.AutoSDKServer[] s_GetBridgeCommandServers = new global::Opik.AutoSDKServer[]
        ...
        private static readonly global::Opik.EndPointSecurityRequirement s_GetBridgeCommandSecurityRequirement0 =
        ...
        private static readonly global::Opik.EndPointSecurityRequirement[] s_GetBridgeCommandSecurityRequirements =
            new global::Opik.EndPointSecurityRequirement[]
            {                s_GetBridgeCommandSecurityRequirement0,
            };
        partial void PrepareGetBridgeCommandArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref global::System.Guid runnerId,
            ref global::System.Guid commandId,
            ref bool? wait,
            ref int? timeout);
        partial void PrepareGetBridgeCommandRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            bool? wait,
            int? timeout);
        partial void ProcessGetBridgeCommandResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetBridgeCommandResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Opik.BridgeCommand> GetBridgeCommandAsync(
            global::System.Guid runnerId,
            global::System.Guid commandId,
            bool? wait = default,
            int? timeout = default,
        ...
        {
            var __response = await GetBridgeCommandAsResponseAsync(
                runnerId: runnerId,
                commandId: commandId,
                wait: wait,
                timeout: timeout,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Opik.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Opik.AutoSDKHttpResponse<global::Opik.BridgeCommand>> GetBridgeCommandAsResponseAsync(
            global::System.Guid runnerId,
            global::System.Guid commandId,
            bool? wait = default,
            int? timeout = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetBridgeCommandArguments(
            ...
            var __authorizations = global::Opik.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetBridgeCommandSecurityRequirements,
                operationName: "GetBridgeCommandAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Opik.PathBuilder(
                                ...
                                servers: s_GetBridgeCommandServers,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Opik.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Opik.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "GetBridgeCommandAsync",
                                pathTemplate: "$\"/v1/private/local-runners/{runnerId}/bridge/commands/{commandId}\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetBridgeCommandResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Opik.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetBridgeCommandResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Opik.BridgeCommand.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Opik.AutoSDKHttpResponse<global::Opik.BridgeCommand>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Opik.BridgeCommand.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
