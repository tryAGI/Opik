    ...
    public partial class ProjectsClient
    {
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            if ((int)__response.StatusCode == 422)
            {
                ...
                throw new global::Opik.ApiException<global::Opik.ErrorMessageDetailed>(
            ...
            if (ReadResponseAsString)
            {
                ...
                try
                {
                    ...
                    return
                        global::Opik.ProjectDetailed.FromJson(__content, JsonSerializerContext) ??
            ...
            else
            {
                try
                {
                    ...
                    return
                        await global::Opik.ProjectDetailed.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
