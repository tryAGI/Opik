...
namespace Opik
{
    public partial class RunnersClient
    {
        ...
        private static readonly global::Opik.AutoSDKServer[] s_NextBridgeCommandsServers = new global::Opik.AutoSDKServer[]
        ...
        private static readonly global::Opik.EndPointSecurityRequirement s_NextBridgeCommandsSecurityRequirement0 =
        ...
        private static readonly global::Opik.EndPointSecurityRequirement[] s_NextBridgeCommandsSecurityRequirements =
            new global::Opik.EndPointSecurityRequirement[]
            {                s_NextBridgeCommandsSecurityRequirement0,
            };
        partial void PrepareNextBridgeCommandsArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref global::System.Guid runnerId,
            global::Opik.BridgeCommandNextRequest request);
        partial void PrepareNextBridgeCommandsRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::System.Guid runnerId,
            global::Opik.BridgeCommandNextRequest request);
        partial void ProcessNextBridgeCommandsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessNextBridgeCommandsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Opik.BridgeCommandBatchResponse> NextBridgeCommandsAsync(
            global::System.Guid runnerId,
        ...
        {
            var __response = await NextBridgeCommandsAsResponseAsync(
                runnerId: runnerId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Opik.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Opik.AutoSDKHttpResponse<global::Opik.BridgeCommandBatchResponse>> NextBridgeCommandsAsResponseAsync(
            global::System.Guid runnerId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareNextBridgeCommandsArguments(
            ...
            var __authorizations = global::Opik.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_NextBridgeCommandsSecurityRequirements,
                operationName: "NextBridgeCommandsAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Opik.PathBuilder(
                                ...
                                servers: s_NextBridgeCommandsServers,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Opik.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Opik.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "NextBridgeCommandsAsync",
                                pathTemplate: "$\"/v1/private/local-runners/{runnerId}/bridge/commands/next\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessNextBridgeCommandsResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Opik.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessNextBridgeCommandsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Opik.BridgeCommandBatchResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Opik.AutoSDKHttpResponse<global::Opik.BridgeCommandBatchResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Opik.BridgeCommandBatchResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Opik.BridgeCommandBatchResponse> NextBridgeCommandsAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Opik.BridgeCommandNextRequest
            {
                MaxCommands = maxCommands,
            };

            return await NextBridgeCommandsAsync(
                runnerId: runnerId,
                request: __request,
                requestOptions: requestOptions,
