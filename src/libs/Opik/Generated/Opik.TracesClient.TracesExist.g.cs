...
namespace Opik
{
    public partial class TracesClient
    {
        ...
        private static readonly global::Opik.AutoSDKServer[] s_TracesExistServers = new global::Opik.AutoSDKServer[]
        ...
        private static readonly global::Opik.EndPointSecurityRequirement s_TracesExistSecurityRequirement0 =
        ...
        private static readonly global::Opik.EndPointSecurityRequirement[] s_TracesExistSecurityRequirements =
            new global::Opik.EndPointSecurityRequirement[]
            {                s_TracesExistSecurityRequirement0,
            };
        partial void PrepareTracesExistArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref global::System.Guid? projectId,
            ref string? projectName,
            ref string? source,
            ref bool? threadOnly);
        partial void PrepareTracesExistRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? source,
            bool? threadOnly);
        partial void ProcessTracesExistResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessTracesExistResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Opik.ExistenceResponse> TracesExistAsync(
        ...
        {
            var __response = await TracesExistAsResponseAsync(
                projectId: projectId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Opik.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Opik.AutoSDKHttpResponse<global::Opik.ExistenceResponse>> TracesExistAsResponseAsync(
            global::System.Guid? projectId = default,
            string? projectName = default,
            string? source = default,
            bool? threadOnly = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareTracesExistArguments(
                httpClient: HttpClient,
                projectId: ref projectId,
                projectName: ref projectName,
                source: ref source,
                threadOnly: ref threadOnly);


            var __authorizations = global::Opik.EndPointSecurityResolver.ResolveAuthorizations(
                availableAuthorizations: Authorizations,
                securityRequirements: s_TracesExistSecurityRequirements,
                operationName: "TracesExistAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            __pathBuilder
                                ...
                                .AddOptionalParameter("thread_only", threadOnly?.ToString().ToLowerInvariant())
                                ;
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Opik.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Opik.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "TracesExistAsync",
                                pathTemplate: "\"/v1/private/traces/exists\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                else
                {
                    await global::Opik.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessTracesExistResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Opik.ExistenceResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Opik.AutoSDKHttpResponse<global::Opik.ExistenceResponse>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Opik.ExistenceResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
