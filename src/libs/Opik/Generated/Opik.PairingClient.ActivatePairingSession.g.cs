...
namespace Opik
{
    public partial class PairingClient
    {
        ...
        {
            await ActivatePairingSessionAsResponseAsync(
                sessionId: sessionId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Opik.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Opik.AutoSDKHttpResponse> ActivatePairingSessionAsResponseAsync(
            global::System.Guid sessionId,
