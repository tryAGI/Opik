...
namespace Opik
{
    public partial class SystemAnalyticsQueriesClient
    {

        private static readonly global::Opik.AutoSDKServer[] s_ExecuteAnalyticsQueryServers = new global::Opik.AutoSDKServer[]
        ...
        private static readonly global::Opik.EndPointSecurityRequirement s_ExecuteAnalyticsQuerySecurityRequirement0 =
        ...
        private static readonly global::Opik.EndPointSecurityRequirement[] s_ExecuteAnalyticsQuerySecurityRequirements =
            new global::Opik.EndPointSecurityRequirement[]
            {                s_ExecuteAnalyticsQuerySecurityRequirement0,
            };
        partial void PrepareExecuteAnalyticsQueryArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref global::System.Guid projectId,
            global::Opik.AnalyticsQueryRequest request);
        partial void PrepareExecuteAnalyticsQueryRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::System.Guid projectId,
            global::Opik.AnalyticsQueryRequest request);
        partial void ProcessExecuteAnalyticsQueryResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessExecuteAnalyticsQueryResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Opik.AnalyticsQueryResponse> ExecuteAnalyticsQueryAsync(
            global::System.Guid projectId,
        ...
        {
            var __response = await ExecuteAnalyticsQueryAsResponseAsync(
                projectId: projectId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Opik.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Opik.AutoSDKHttpResponse<global::Opik.AnalyticsQueryResponse>> ExecuteAnalyticsQueryAsResponseAsync(
            global::System.Guid projectId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareExecuteAnalyticsQueryArguments(
            ...
            var __authorizations = global::Opik.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ExecuteAnalyticsQuerySecurityRequirements,
                operationName: "ExecuteAnalyticsQueryAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Opik.PathBuilder(
                                ...
                                servers: s_ExecuteAnalyticsQueryServers,
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareExecuteAnalyticsQueryRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Opik.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Opik.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "ExecuteAnalyticsQueryAsync",
                                pathTemplate: "$\"/v1/internal/analytics-queries/projects/{projectId}\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessExecuteAnalyticsQueryResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Opik.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessExecuteAnalyticsQueryResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Opik.AnalyticsQueryResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Opik.AutoSDKHttpResponse<global::Opik.AnalyticsQueryResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Opik.AnalyticsQueryResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Opik.AnalyticsQueryResponse> ExecuteAnalyticsQueryAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Opik.AnalyticsQueryRequest
            {
                Query = query,
            };

            return await ExecuteAnalyticsQueryAsync(
                projectId: projectId,
                request: __request,
                requestOptions: requestOptions,
