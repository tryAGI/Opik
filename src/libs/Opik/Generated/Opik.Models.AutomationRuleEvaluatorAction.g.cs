...
namespace Opik
{
    ...
    public static class AutomationRuleEvaluatorActionExtensions
    {
        ...
        public static string ToValueString(this AutomationRuleEvaluatorAction value)
        {
            return value switch
            {
                AutomationRuleEvaluatorAction.AnnotationQueueRouter => "annotation_queue_router",
        ...
        public static AutomationRuleEvaluatorAction? ToEnum(string value)
        {
            return value switch
            {
                "annotation_queue_router" => AutomationRuleEvaluatorAction.AnnotationQueueRouter,
