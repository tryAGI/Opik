...
namespace Opik
{
    public partial class WorkspacesClient
    {
        ...
        private static readonly global::Opik.AutoSDKServer[] s_GetWorkspaceTokenUsageNamesServers = new global::Opik.AutoSDKServer[]
        ...
        private static readonly global::Opik.EndPointSecurityRequirement s_GetWorkspaceTokenUsageNamesSecurityRequirement0 =
        ...
        private static readonly global::Opik.EndPointSecurityRequirement[] s_GetWorkspaceTokenUsageNamesSecurityRequirements =
            new global::Opik.EndPointSecurityRequirement[]
            {                s_GetWorkspaceTokenUsageNamesSecurityRequirement0,
            };
        partial void PrepareGetWorkspaceTokenUsageNamesArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::Opik.WorkspaceTokenUsageNamesRequest request);
        partial void PrepareGetWorkspaceTokenUsageNamesRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::Opik.WorkspaceTokenUsageNamesRequest request);
        partial void ProcessGetWorkspaceTokenUsageNamesResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetWorkspaceTokenUsageNamesResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Opik.TokenUsageNames> GetWorkspaceTokenUsageNamesAsync(

            global::Opik.WorkspaceTokenUsageNamesRequest request,
            global::Opik.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await GetWorkspaceTokenUsageNamesAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Opik.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Opik.AutoSDKHttpResponse<global::Opik.TokenUsageNames>> GetWorkspaceTokenUsageNamesAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareGetWorkspaceTokenUsageNamesArguments(
            ...
            var __authorizations = global::Opik.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetWorkspaceTokenUsageNamesSecurityRequirements,
                operationName: "GetWorkspaceTokenUsageNamesAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Opik.PathBuilder(
                                ...
                                servers: s_GetWorkspaceTokenUsageNamesServers,
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGetWorkspaceTokenUsageNamesRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Opik.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Opik.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "GetWorkspaceTokenUsageNames",
                                methodName: "GetWorkspaceTokenUsageNamesAsync",
                                pathTemplate: "\"/v1/private/workspaces/token-usage/names\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetWorkspaceTokenUsageNamesResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Opik.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetWorkspaceTokenUsageNamesResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Opik.TokenUsageNames.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Opik.AutoSDKHttpResponse<global::Opik.TokenUsageNames>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Opik.TokenUsageNames.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Opik.TokenUsageNames> GetWorkspaceTokenUsageNamesAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Opik.WorkspaceTokenUsageNamesRequest
            {
                ProjectIds = projectIds,
            };

            return await GetWorkspaceTokenUsageNamesAsync(
                request: __request,
                requestOptions: requestOptions,
