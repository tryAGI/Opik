...
namespace Opik
{
    ...
    public sealed partial class EvaluatorItemCompare
    {
        ...
        [global::System.Text.Json.Serialization.JsonConverter(typeof(global::Opik.JsonConverters.EvaluatorItemCompareTypeJsonConverter))]
        [global::System.Text.Json.Serialization.JsonRequired]
        public required global::Opik.EvaluatorItemCompareType Type { get; set; }
