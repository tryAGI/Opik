...
namespace Opik
{
    public partial class ExperimentsClient
    {
        ...
        private static readonly global::Opik.AutoSDKServer[] s_ExecuteExperimentServers = new global::Opik.AutoSDKServer[]
        ...
        private static readonly global::Opik.EndPointSecurityRequirement s_ExecuteExperimentSecurityRequirement0 =
        ...
        private static readonly global::Opik.EndPointSecurityRequirement[] s_ExecuteExperimentSecurityRequirements =
            new global::Opik.EndPointSecurityRequirement[]
            {                s_ExecuteExperimentSecurityRequirement0,
            };
        partial void PrepareExecuteExperimentArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::Opik.ExperimentExecutionRequest request);
        partial void PrepareExecuteExperimentRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::Opik.ExperimentExecutionRequest request);
        partial void ProcessExecuteExperimentResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessExecuteExperimentResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Opik.ExperimentExecutionResponse> ExecuteExperimentAsync(

            global::Opik.ExperimentExecutionRequest request,
            global::Opik.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await ExecuteExperimentAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Opik.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Opik.AutoSDKHttpResponse<global::Opik.ExperimentExecutionResponse>> ExecuteExperimentAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareExecuteExperimentArguments(
            ...
            var __authorizations = global::Opik.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ExecuteExperimentSecurityRequirements,
                operationName: "ExecuteExperimentAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Opik.PathBuilder(
                                path: "/v1/private/experiments/execute",
                                baseUri: ResolveBaseUri(
                                servers: s_ExecuteExperimentServers,
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareExecuteExperimentRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Opik.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Opik.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "ExecuteExperimentAsync",
                                pathTemplate: "\"/v1/private/experiments/execute\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessExecuteExperimentResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Opik.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessExecuteExperimentResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Opik.ExperimentExecutionResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Opik.AutoSDKHttpResponse<global::Opik.ExperimentExecutionResponse>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Opik.ExperimentExecutionResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Opik.ExperimentExecutionResponse> ExecuteExperimentAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Opik.ExperimentExecutionRequest
            {
            ...
            return await ExecuteExperimentAsync(
                request: __request,
                requestOptions: requestOptions,
