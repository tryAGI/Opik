...
namespace Opik
{
    public partial class DatasetsClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Opik.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Opik.AutoSDKHttpResponse<global::Opik.DatasetVersionPublic>> RestoreDatasetVersionAsResponseAsync(
            global::System.Guid id,
            ...
            try
            {
                ...
                else
                {
                    await global::Opik.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            // Concurrent modification - the latest version changed during the restore; retry
