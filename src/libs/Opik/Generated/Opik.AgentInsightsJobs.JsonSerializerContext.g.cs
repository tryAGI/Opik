...
namespace Opik
{
    ...
    public sealed partial class AgentInsightsJobsSourceGenerationContext : global::System.Text.Json.Serialization.JsonSerializerContext
    {
        ...
        ///
        /// </summary>
        public static AgentInsightsJobsSourceGenerationContext Default { get; } = new(DefaultOptions);

        private AgentInsightsJobsSourceGenerationContext(global::System.Text.Json.JsonSerializerOptions options)
            : base(options)
        {
        }
