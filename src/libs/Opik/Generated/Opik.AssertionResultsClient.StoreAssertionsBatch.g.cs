...
namespace Opik
{
    public partial class AssertionResultsClient
    {

        private static readonly global::Opik.AutoSDKServer[] s_StoreAssertionsBatchServers = new global::Opik.AutoSDKServer[]
        ...
        private static readonly global::Opik.EndPointSecurityRequirement s_StoreAssertionsBatchSecurityRequirement0 =
        ...
        private static readonly global::Opik.EndPointSecurityRequirement[] s_StoreAssertionsBatchSecurityRequirements =
            new global::Opik.EndPointSecurityRequirement[]
            {                s_StoreAssertionsBatchSecurityRequirement0,
            };
        partial void PrepareStoreAssertionsBatchArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::Opik.AssertionResultBatch request);
        partial void PrepareStoreAssertionsBatchRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::Opik.AssertionResultBatch request);
        partial void ProcessStoreAssertionsBatchResponse(
            global::System.Net.Http.HttpClient httpClient,
        ...
        public async global::System.Threading.Tasks.Task StoreAssertionsBatchAsync(

            global::Opik.AssertionResultBatch request,
            global::Opik.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            await StoreAssertionsBatchAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Opik.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Opik.AutoSDKHttpResponse> StoreAssertionsBatchAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareStoreAssertionsBatchArguments(
            ...
            var __authorizations = global::Opik.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_StoreAssertionsBatchSecurityRequirements,
                operationName: "StoreAssertionsBatchAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Opik.PathBuilder(
                                ...
                                servers: s_StoreAssertionsBatchServers,
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareStoreAssertionsBatchRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Opik.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Opik.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "StoreAssertionsBatch",
                                methodName: "StoreAssertionsBatchAsync",
                                pathTemplate: "\"/v1/private/assertion-results\"",
                                httpMethod: "PUT",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessStoreAssertionsBatchResponse(
                    httpClient: HttpClient,
        ...
        public async global::System.Threading.Tasks.Task StoreAssertionsBatchAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Opik.AssertionResultBatch
            {
                EntityType = entityType,
                AssertionResults = assertionResults,
            };

            await StoreAssertionsBatchAsync(
                request: __request,
                requestOptions: requestOptions,
