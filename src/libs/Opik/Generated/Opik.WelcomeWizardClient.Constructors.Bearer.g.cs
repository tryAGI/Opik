...
namespace Opik
{
    public sealed partial class WelcomeWizardClient
    {
        /// <inheritdoc cref="WelcomeWizardClient(global::System.Net.Http.HttpClient?, global::System.Uri?, global::System.Collections.Generic.List{global::Opik.EndPointAuthorization}?, bool)"/>
        ...
        /// <summary>
        /// Creates an authenticated WelcomeWizardClient by resolving the configured credential environment variables.
        /// </summary>
        ...
        public static WelcomeWizardClient CreateFromEnvironment(
            global::System.Net.Http.HttpClient? httpClient = null,
            global::System.Uri? baseUri = null,
            global::System.Collections.Generic.List<global::Opik.EndPointAuthorization>? authorizations = null,
            ...
            bool disposeHttpClient = true)
        {
            ...
            var client = new WelcomeWizardClient(
                httpClient,
                baseUri,
                authorizations,
                options,
        ...
        /// <summary>
        /// Tries to create an authenticated WelcomeWizardClient by resolving the configured credential environment variables.
        /// </summary>
        ...
        public static bool TryCreateFromEnvironment(
            out WelcomeWizardClient? client,
            global::System.Net.Http.HttpClient? httpClient = null,
            global::System.Uri? baseUri = null,
            global::System.Collections.Generic.List<global::Opik.EndPointAuthorization>? authorizations = null,
            global::Opik.AutoSDKClientOptions? options = null,
            bool disposeHttpClient = true)
        {
            ...
            client = new WelcomeWizardClient(
                httpClient,
                baseUri,
                authorizations,
                options,
