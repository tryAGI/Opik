...
namespace Opik
{
    public partial class DatasetsClient
    {
        ...
        private static readonly global::Opik.AutoSDKServer[] s_ApplyDatasetItemChangesServers = new global::Opik.AutoSDKServer[]
        ...
        private static readonly global::Opik.EndPointSecurityRequirement s_ApplyDatasetItemChangesSecurityRequirement0 =
        ...
        private static readonly global::Opik.EndPointSecurityRequirement[] s_ApplyDatasetItemChangesSecurityRequirements =
            new global::Opik.EndPointSecurityRequirement[]
            {                s_ApplyDatasetItemChangesSecurityRequirement0,
            };
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Opik.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Opik.AutoSDKHttpResponse<global::Opik.DatasetVersionPublic>> ApplyDatasetItemChangesAsResponseAsync(
            global::System.Guid id,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::Opik.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ApplyDatasetItemChangesSecurityRequirements,
                operationName: "ApplyDatasetItemChangesAsync");
                ...
                else
                {
                    await global::Opik.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 409)
                            {
                                ...
                                global::Opik.ErrorMessagePublic? __value_409 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_409 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_409 = global::Opik.ErrorMessagePublic.FromJson(__content_409, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_409 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Opik.DatasetVersionPublic.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Opik.AutoSDKHttpResponse<global::Opik.DatasetVersionPublic>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Opik.DatasetVersionPublic.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
