...
namespace Opik
{
    ...
    public sealed class AutoSDKConditionalResponse<T>
    {
        internal AutoSDKConditionalResponse(
            bool notModified,
            string? entityTag,
            global::Opik.AutoSDKHttpResponse<T>? response)
        {
        ...
        public global::Opik.AutoSDKHttpResponse<T>? Response { get; }
    }
    ...
    public static class AutoSDKConditionalRequests
    {
        ...
        /// </summary>
        public static async global::System.Threading.Tasks.Task<global::Opik.AutoSDKConditionalResponse<T>> SendAsync<T>(
            global::System.Func<global::Opik.AutoSDKRequestOptions, global::System.Threading.CancellationToken, global::System.Threading.Tasks.Task<global::Opik.AutoSDKHttpResponse<T>>> send,
            string? entityTag = null,
            global::Opik.AutoSDKRequestOptions? requestOptions = null,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return new global::Opik.AutoSDKConditionalResponse<T>(
                    notModified: false,
                    entityTag: GetEntityTag(response.Headers),
                    response: response);
            }
            catch (global::Opik.ApiException exception)
        ...
        private static global::Opik.AutoSDKRequestOptions CloneRequestOptions(
            global::Opik.AutoSDKRequestOptions? source)
        {
            var clone = new global::Opik.AutoSDKRequestOptions();
            if (source == null)
            {
                return clone;
            }
