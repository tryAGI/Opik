...
namespace Opik
{
    public sealed partial class AgentInsightsEnrollmentClient
    {
        /// <inheritdoc cref="AgentInsightsEnrollmentClient(global::System.Net.Http.HttpClient?, global::System.Uri?, global::System.Collections.Generic.List{global::Opik.EndPointAuthorization}?, bool)"/>

        public AgentInsightsEnrollmentClient(
            string apiKey,
        ...
        /// <summary>
        /// Creates an authenticated AgentInsightsEnrollmentClient by resolving the configured credential environment variables.
        /// </summary>
        ...
        public static AgentInsightsEnrollmentClient CreateFromEnvironment(
            global::System.Net.Http.HttpClient? httpClient = null,
            global::System.Uri? baseUri = null,
            global::System.Collections.Generic.List<global::Opik.EndPointAuthorization>? authorizations = null,
            ...
            bool disposeHttpClient = true)
        {
            ...
            if (credentialValue is null)
            {
                throw new global::System.InvalidOperationException(
                    "No non-empty credential environment variable value was found. Checked: OPIK_API_KEY.");
            }
            ...
            var client = new AgentInsightsEnrollmentClient(
                httpClient,
                baseUri,
                authorizations,
                options,
        ...
        /// <summary>
        /// Tries to create an authenticated AgentInsightsEnrollmentClient by resolving the configured credential environment variables.
        /// </summary>
        ...
        public static bool TryCreateFromEnvironment(
            out AgentInsightsEnrollmentClient? client,
            global::System.Net.Http.HttpClient? httpClient = null,
            global::System.Uri? baseUri = null,
            global::System.Collections.Generic.List<global::Opik.EndPointAuthorization>? authorizations = null,
            global::Opik.AutoSDKClientOptions? options = null,
            bool disposeHttpClient = true)
        {
            ...
            client = new AgentInsightsEnrollmentClient(
                httpClient,
                baseUri,
                authorizations,
                options,
