...
namespace Opik
{
    public partial class AiSpendClient
    {
        ...
        public async global::System.Threading.Tasks.Task<global::Opik.SpendUserPage> GetSpendUsersAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Opik.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Opik.AutoSDKHttpResponse<global::Opik.SpendUserPage>> GetSpendUsersAsResponseAsync(
                    ...
                    await global::Opik.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    return new global::Opik.AutoSDKHttpResponse<global::Opik.SpendUserPage>(
                                        statusCode: __response.StatusCode,
