...
namespace Opik
{
    ...
    public sealed partial class LlmProviderKeySourceGenerationContext : global::System.Text.Json.Serialization.JsonSerializerContext
    {
        ...
        ///
        /// </summary>
        public static LlmProviderKeySourceGenerationContext Default { get; } = new(DefaultOptions);

        private LlmProviderKeySourceGenerationContext(global::System.Text.Json.JsonSerializerOptions options)
            : base(options)
        {
        }
