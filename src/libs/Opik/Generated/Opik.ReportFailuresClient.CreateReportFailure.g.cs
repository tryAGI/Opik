...
namespace Opik
{
    public partial class ReportFailuresClient
    {
        ...
        private static readonly global::Opik.AutoSDKServer[] s_CreateReportFailureServers = new global::Opik.AutoSDKServer[]
        ...
        private static readonly global::Opik.EndPointSecurityRequirement s_CreateReportFailureSecurityRequirement0 =
        ...
        private static readonly global::Opik.EndPointSecurityRequirement[] s_CreateReportFailureSecurityRequirements =
            new global::Opik.EndPointSecurityRequirement[]
            {                s_CreateReportFailureSecurityRequirement0,
            };
        partial void PrepareCreateReportFailureArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::Opik.ReportFailure request);
        partial void PrepareCreateReportFailureRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::Opik.ReportFailure request);
        partial void ProcessCreateReportFailureResponse(
            global::System.Net.Http.HttpClient httpClient,
        ...
        public async global::System.Threading.Tasks.Task CreateReportFailureAsync(

            global::Opik.ReportFailure request,
            global::Opik.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            await CreateReportFailureAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Opik.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Opik.AutoSDKHttpResponse> CreateReportFailureAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareCreateReportFailureArguments(
            ...
            var __authorizations = global::Opik.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CreateReportFailureSecurityRequirements,
                operationName: "CreateReportFailureAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Opik.PathBuilder(
                                ...
                                servers: s_CreateReportFailureServers,
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareCreateReportFailureRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Opik.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Opik.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "CreateReportFailure",
                                methodName: "CreateReportFailureAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCreateReportFailureResponse(
                    httpClient: HttpClient,
        ...
        public async global::System.Threading.Tasks.Task CreateReportFailureAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Opik.ReportFailure
            {
                Type = type,
                ProjectId = projectId,
                Reason = reason,
            ...
            await CreateReportFailureAsync(
                request: __request,
                requestOptions: requestOptions,
