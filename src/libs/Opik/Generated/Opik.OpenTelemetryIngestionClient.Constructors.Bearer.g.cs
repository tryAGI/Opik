...
namespace Opik
{
    public sealed partial class OpenTelemetryIngestionClient
    {
        /// <inheritdoc cref="OpenTelemetryIngestionClient(global::System.Net.Http.HttpClient?, global::System.Uri?, global::System.Collections.Generic.List{global::Opik.EndPointAuthorization}?, bool)"/>
        ...
        /// <summary>
        /// Creates an authenticated OpenTelemetryIngestionClient by resolving the configured credential environment variables.
        /// </summary>
        ...
        public static OpenTelemetryIngestionClient CreateFromEnvironment(
            global::System.Net.Http.HttpClient? httpClient = null,
            global::System.Uri? baseUri = null,
            global::System.Collections.Generic.List<global::Opik.EndPointAuthorization>? authorizations = null,
            ...
            bool disposeHttpClient = true)
        {
            ...
            var client = new OpenTelemetryIngestionClient(
                httpClient,
                baseUri,
                authorizations,
                options,
        ...
        /// <summary>
        /// Tries to create an authenticated OpenTelemetryIngestionClient by resolving the configured credential environment variables.
        /// </summary>
        ...
        public static bool TryCreateFromEnvironment(
            out OpenTelemetryIngestionClient? client,
            global::System.Net.Http.HttpClient? httpClient = null,
            global::System.Uri? baseUri = null,
            global::System.Collections.Generic.List<global::Opik.EndPointAuthorization>? authorizations = null,
            global::Opik.AutoSDKClientOptions? options = null,
            bool disposeHttpClient = true)
        {
            ...
            client = new OpenTelemetryIngestionClient(
                httpClient,
                baseUri,
                authorizations,
                options,
