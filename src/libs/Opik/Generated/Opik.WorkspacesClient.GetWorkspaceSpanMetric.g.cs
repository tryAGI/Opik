...
namespace Opik
{
    public partial class WorkspacesClient
    {
        ...
        private static readonly global::Opik.AutoSDKServer[] s_GetWorkspaceSpanMetricServers = new global::Opik.AutoSDKServer[]
        ...
        private static readonly global::Opik.EndPointSecurityRequirement s_GetWorkspaceSpanMetricSecurityRequirement0 =
        ...
        private static readonly global::Opik.EndPointSecurityRequirement[] s_GetWorkspaceSpanMetricSecurityRequirements =
            new global::Opik.EndPointSecurityRequirement[]
            {                s_GetWorkspaceSpanMetricSecurityRequirement0,
            };
        partial void PrepareGetWorkspaceSpanMetricArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::Opik.WorkspaceSpanMetricRequest request);
        partial void PrepareGetWorkspaceSpanMetricRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::Opik.WorkspaceSpanMetricRequest request);
        partial void ProcessGetWorkspaceSpanMetricResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetWorkspaceSpanMetricResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Opik.WorkspaceMetricResponse> GetWorkspaceSpanMetricAsync(

            global::Opik.WorkspaceSpanMetricRequest request,
            global::Opik.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await GetWorkspaceSpanMetricAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Opik.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Opik.AutoSDKHttpResponse<global::Opik.WorkspaceMetricResponse>> GetWorkspaceSpanMetricAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareGetWorkspaceSpanMetricArguments(
            ...
            var __authorizations = global::Opik.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetWorkspaceSpanMetricSecurityRequirements,
                operationName: "GetWorkspaceSpanMetricAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Opik.PathBuilder(
                                ...
                                servers: s_GetWorkspaceSpanMetricServers,
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGetWorkspaceSpanMetricRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Opik.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Opik.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "GetWorkspaceSpanMetric",
                                methodName: "GetWorkspaceSpanMetricAsync",
                                pathTemplate: "\"/v1/private/workspaces/metrics/spans\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetWorkspaceSpanMetricResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Opik.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetWorkspaceSpanMetricResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Opik.WorkspaceMetricResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Opik.AutoSDKHttpResponse<global::Opik.WorkspaceMetricResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Opik.WorkspaceMetricResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Opik.WorkspaceMetricResponse> GetWorkspaceSpanMetricAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Opik.WorkspaceSpanMetricRequest
            {
            ...
            return await GetWorkspaceSpanMetricAsync(
                request: __request,
                requestOptions: requestOptions,
